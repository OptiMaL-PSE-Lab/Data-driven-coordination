...
def centralised(data):
    ...
    model.N_j = pyo.Param()
    # model.N_k = pyo.Param()
    model.k = pyo.RangeSet(1, data[None]['N'][None])
    model.i = pyo.RangeSet(1, data[None]['N_i'][None])
    model.j = pyo.RangeSet(1, data[None]['N_j'][None])
    model.x_k_s = pyo.RangeSet(1, 2*data[None]['N'][None])
